...
| --- | --- |
| Traer manuscrito, notas, versiones o conversaciones | [Importar](.claude/skills/import/SKILL.md) |
| Evaluar el material existente y elegir por dónde empezar | [Evaluar](.claude/skills/assess/SKILL.md) |
| Pensar una escena, arco, mundo, alternativa o revisión | [Planificar](.claude/skills/plan/SKILL.md) |
| Escribir prosa nueva según el encargo | [Redactar](.claude/skills/draft/SKILL.md) |
| Cambiar una prosa existente, conservando lo indicado | [Revisar](.claude/skills/revise/SKILL.md) |
| Comprobar, criticar o leer en frío sin reescribir | [Examinar](.claude/skills/review/SKILL.md) |
| Investigar una pregunta externa o técnica de escritura | [Investigar](.claude/skills/research/SKILL.md) |
| Retomar, guardar un punto, cerrar o exportar explícitamente | [Retomar y cerrar](.claude/skills/handoff/SKILL.md) |
